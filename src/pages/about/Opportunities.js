  ...
  return (
    <Container maxWidth="md" sx={{ textAlign: "center", py: 5 }}>
      ...
      <Box mt={3} display="flex" justifyContent="center" gap={2}>
        <Button variant="contained" color="success" sx={{bgcolor:"#374d91"}}>WORK WITH US</Button>
        <Button variant="contained" color="success" sx={{bgcolor:"#374d91"}}>DELIVER WITH US</Button>
      </Box>
    </Container>
  );
};
